jQuery.extend({speech:function(e){this._validate(e),this._request(e)},_validate:function(e){
	...
	if(!a)
		throw"The browser does not support the audio codec "+e.c}},_request:function(e){
			$.ajax({type:"POST",url:"https://api.voicerss.org/",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:this._buildRequest(e),dataType:"text",success:function(e,a,c){
				if(0==e.indexOf("ERROR"))throw e;new Audio(e).play()}})},_buildRequest:function(e){var a=e.c&&"auto"!=e.c.toLowerCase()?e.c:this._detectCodec();
